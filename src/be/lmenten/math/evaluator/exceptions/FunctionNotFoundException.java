	...
	extends EvaluateException
{
	...
	public FunctionNotFoundException( String functionName, String functionNameSuffix, int pos, int length )
	{
		super( Reason.FUNCTION_NOT_FOUND );
	...
	{
		return MessageFormat.format( $("FUNCTION_NOT_FOUND"),
			getFunctionName(),
			getFunctionNameSuffix()
		);
	}
}
